            ...
            <div class="container-fluid px-0">
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-3 rounded-3"
                        aria-labelledby="dropdownProfil" style="min-width: 250px;">
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item py-2 text-danger fw-bold d-flex align-items-center justify-content-center bg-danger bg-opacity-10 rounded-bottom"
