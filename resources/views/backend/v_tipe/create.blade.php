...
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm p-3" style="border-radius: 20px;">
            <div class="card-body">
                <form action="{{ route('backend.tipe.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_tipe" class="form-control form-control-lg border-0 bg-light @error('nama_tipe') is-invalid @enderror" 
                               value="{{ old('nama_tipe') }}" placeholder="Misal: SUV, MPV, Hatchback" style="border-radius: 12px; font-size: 16px;">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" class="form-control border-0 bg-light" rows="5" 
                                  placeholder="Jelaskan karakteristik tipe ini..." style="border-radius: 12px;">{{ old('deskripsi') }}</textarea>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="btn w-100 py-3 border-0 shadow-sm" 
                                style="background: #001437; color: white; border-radius: 12px; font-weight: 600; letter-spacing: 0.5px;">
